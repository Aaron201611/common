...
public class ErrorCode {
	...
	/**权限被授权，不得取消*/
	public static final String AUTH_NOT_CANCEL = "valid_auth_donot_cancel";

	/**编号不唯一*/
	public static final String NO_NOT_UNIQUE = "valid_common_no_not_unique";
	/**无操作权限*/
	public static final String NO_POWER = "valid_common_nopower_error";
	/**参数为空*/
	public static final String PARAM_EMPTY = "valid_common_param_empty";
	/**未知异常*/
