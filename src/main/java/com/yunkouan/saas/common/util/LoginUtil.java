...
public final class LoginUtil {
	...
	public static Principal getLoginUser() {
		...
		// TODO 测试环境使用
//		Principal user = new Principal("384D873241D341B282253346CA481DCE", "admin", "admin", "admin", "", Constant.STATUS_ACTIVE, 1, "", false, SysAuth.AUTH_LEVEL_PLATFORM_ADMIN, "75BCC60D6A494E4296EF319A91EFC17E", "1");
		return user;
	}
